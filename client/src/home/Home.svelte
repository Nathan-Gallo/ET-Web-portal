...
<div class="goals">
  <ul class="flex">
    <li class="interactive static"> 
      Excellence <div class="vl"></div>
      <ul><li>Be the Pathfinders for new technology at The Hartford, guiding everyone forward and upward</li></ul>
    </li>
    <li class="interactive static">Explore</li>
    <li class="interactive static">
      Engage
    </li>
    <li class="interactive static">Deliver</li>
  </ul>
</div>
</main>
